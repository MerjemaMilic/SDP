...
public class AlifakovacActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingsalif;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        referenceRatingsalif = FirebaseDatabase.getInstance().getReference("ratings/Alifakovac");

        referenceRatingsalif.addValueEventListener(new ValueEventListener() {
            @Override
