...
public class AlipasinMostActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingsalipasinmost;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        referenceRatingsalipasinmost = FirebaseDatabase.getInstance().getReference("ratings/Alipasin Most");

        referenceRatingsalipasinmost.addValueEventListener(new ValueEventListener() {
            @Override
