...
public class AlipasinoPoljeActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingsalipasinopolje;
...
setContentView(R.layout.activity_alipasino_polje);
        ...
        referenceRatingsalipasinopolje = FirebaseDatabase.getInstance().getReference("ratings/Alipasino Polje");

        referenceRatingsalipasinopolje.addValueEventListener(new ValueEventListener() {
            @Override
