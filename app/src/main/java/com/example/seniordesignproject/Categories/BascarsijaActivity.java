...
public class BascarsijaActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingsbascarsija;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        referenceRatingsbascarsija = FirebaseDatabase.getInstance().getReference("ratings/Bascarsija");

        referenceRatingsbascarsija.addValueEventListener(new ValueEventListener() {
            @Override
