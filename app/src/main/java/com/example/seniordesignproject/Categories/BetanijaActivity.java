...
public class BetanijaActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingsbetanija;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_betanija);
        ...
        mFirestoreList = findViewById(R.id.dobojrecycler);

        referenceRatingsbetanija = FirebaseDatabase.getInstance().getReference("ratings/Betanija");

        referenceRatingsbetanija.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood", "Betanija");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, BetanijaActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public BetanijaActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new BetanijaActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull BetanijaActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
