...
public class BistrikActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingsbistrik;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        referenceRatingsbistrik = FirebaseDatabase.getInstance().getReference("ratings/Bistrik");

        referenceRatingsbistrik.addValueEventListener(new ValueEventListener() {
            @Override
