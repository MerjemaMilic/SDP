...
public class CengicVilaActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingcengicvila;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        referenceRatingcengicvila = FirebaseDatabase.getInstance().getReference("ratings/Cengic Vila");

        referenceRatingcengicvila.addValueEventListener(new ValueEventListener() {
            @Override
