...
public class DobrinjaActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingdobrinja;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dobrinja);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.gradacacrecycler);
        ...
        referenceRatingdobrinja = FirebaseDatabase.getInstance().getReference("ratings/Dobrinja");

        referenceRatingdobrinja.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Dobrinja");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, DobrinjaActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public DobrinjaActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new DobrinjaActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull DobrinjaActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
