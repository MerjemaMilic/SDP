...
public class DolacMaltaActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingdolacmalta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dolac_malta);

        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.graidskarecycler);
        ...
        referenceRatingdolacmalta = FirebaseDatabase.getInstance().getReference("ratings/Dolac Malta");

        referenceRatingdolacmalta.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Dolac Malta");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, DolacMaltaActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public DolacMaltaActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new DolacMaltaActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull DolacMaltaActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
