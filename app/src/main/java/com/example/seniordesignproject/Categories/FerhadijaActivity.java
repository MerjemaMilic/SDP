...
public class FerhadijaActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingferhadija;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ferhadija);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.istocnorecycler);
        ...
        referenceRatingferhadija = FirebaseDatabase.getInstance().getReference("ratings/Ferhadija");

        referenceRatingferhadija.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Ferhadija");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, FerhadijaActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public FerhadijaActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new FerhadijaActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull FerhadijaActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
