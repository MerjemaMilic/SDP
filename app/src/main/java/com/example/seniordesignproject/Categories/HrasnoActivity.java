...
public class HrasnoActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatinghrasno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrasno);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.ljubuskirecycler);
        ...
        referenceRatinghrasno = FirebaseDatabase.getInstance().getReference("ratings/Hrasno");

        referenceRatinghrasno.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Hrasno");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, HrasnoActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public HrasnoActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new HrasnoActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull HrasnoActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
