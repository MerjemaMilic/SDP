...
public class HridJarcedoliActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatinghrid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hrid_jarcedoli);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.mostarrecycler);
        ...
        referenceRatinghrid = FirebaseDatabase.getInstance().getReference("ratings/Hrid-Jarčedoli");

        referenceRatinghrid.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Hrid-Jarčedoli");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, HridJarcedoliActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public HridJarcedoliActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new HridJarcedoliActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull HridJarcedoliActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
