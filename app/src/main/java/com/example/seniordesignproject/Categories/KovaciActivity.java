...
public class KovaciActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingkovaci;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        referenceRatingkovaci = FirebaseDatabase.getInstance().getReference("ratings/Kovači");

        referenceRatingkovaci.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Kovači");
