...
public class KovaciciActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingkovacici;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kovacici);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.sirokibrijegrecycler);
        ...
        referenceRatingkovacici = FirebaseDatabase.getInstance().getReference("ratings/Kovačići");

        referenceRatingkovacici.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Kovačići");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, KovaciciActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public KovaciciActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new KovaciciActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull KovaciciActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
