...
public class MarijinDvorActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingmarijindvor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_marijin_dvor);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.srebrenikrecycler);
        ...
        referenceRatingmarijindvor = FirebaseDatabase.getInstance().getReference("ratings/Marijin Dvor");

        referenceRatingmarijindvor.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Marijin Dvor");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, MarijinDvorActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public MarijinDvorActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new MarijinDvorActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull MarijinDvorActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
