...
public class MojmiloActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingmojmilo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mojmilo);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.trebinjerecycler);
        ...
        referenceRatingmojmilo = FirebaseDatabase.getInstance().getReference("ratings/Mojmilo");

        referenceRatingmojmilo.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Mojmilo");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, MojmiloActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public MojmiloActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new MojmiloActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull MojmiloActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
