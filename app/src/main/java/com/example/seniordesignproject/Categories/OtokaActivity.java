...
public class OtokaActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingotoka;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otoka);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.tuzlarecycler);
        ...
        referenceRatingotoka = FirebaseDatabase.getInstance().getReference("ratings/Otoka");

        referenceRatingotoka.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Otoka");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, OtokaActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public OtokaActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new OtokaActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull OtokaActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
