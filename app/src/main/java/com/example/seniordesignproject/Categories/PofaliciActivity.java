...
public class PofaliciActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingpofalici;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pofalici);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.visokorecycler);
        ...
        referenceRatingpofalici = FirebaseDatabase.getInstance().getReference("ratings/Pofalići");

        referenceRatingpofalici.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Pofalići");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, PofaliciActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public PofaliciActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new PofaliciActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull PofaliciActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
