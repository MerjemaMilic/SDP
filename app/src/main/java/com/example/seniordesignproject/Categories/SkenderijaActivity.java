...
public class SkenderijaActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingskenderija;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skenderija);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.zivinicerecycler);
        ...
        referenceRatingskenderija = FirebaseDatabase.getInstance().getReference("ratings/Skenderija");

        referenceRatingskenderija.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Skenderija");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, SkenderijaActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public SkenderijaActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new SkenderijaActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull SkenderijaActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
