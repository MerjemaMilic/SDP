...
public class VracaActivity extends AppCompatActivity {
    ...
    DatabaseReference referenceRatingvraca;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vraca);
        firebaseFirestore = FirebaseFirestore.getInstance();
        mFirestoreList = findViewById(R.id.zvornikrecycler);
        ...
        referenceRatingvraca = FirebaseDatabase.getInstance().getReference("ratings/Vraca");

        referenceRatingvraca.addValueEventListener(new ValueEventListener() {
            @Override
        ...
        Query query = firebaseFirestore.collection("reviews").whereEqualTo("neighborhood","Vraca");

        FirestoreRecyclerOptions<Rate> options = new FirestoreRecyclerOptions.Builder<Rate>()
                .setQuery(query, Rate.class)
                .build();

        adapter = new FirestoreRecyclerAdapter<Rate, VracaActivity.ProductsViewHolder>(options) {
            @NonNull
            @Override
            public VracaActivity.ProductsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.custom_view, parent, false);
                return new VracaActivity.ProductsViewHolder(view);
            }

            @Override
            protected void onBindViewHolder(@NonNull VracaActivity.ProductsViewHolder productsViewHolder, int i, @NonNull Rate rate) {
